	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'philly': //Week 3
				...
				add(street);
				case "walter":
					var cielo: BGSprite = new BGSprite('walter/sky', -40, 900);
					add (cielo);

					var piso: BGSprite = new BGSprite('walter/floor', -40, 900);
					add (piso);

				case "waltererect":
						var cielo: BGSprite = new BGSprite('walter/erect_sky', -40, 900);
						add (cielo);
	
						var piso: BGSprite = new BGSprite('walter/floor', -40, 900);
						add (piso);

						var lineas: BGSprite = new BGSprite('walter/lineas', -40, 800);
						lineas.scrollFactor.set(0.0, 0.0);
						add (lineas);
