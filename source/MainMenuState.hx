...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		for (i in 3...optionShit.length)
		{
			var offset:Float = 108 - (Math.max(optionShit.length, 4) - 4) * 80;
			var menuItem:FlxSprite = new FlxSprite(180, 0 + (0 * 140)  + offset);
			...
			var offset:Float = 108 - (Math.max(optionShit.length, 4) - 4) * 80;
			var menuItem:FlxSprite = new FlxSprite(290, (1 * 140)  + offset);
			menuItem.scale.x = scale;
			menuItem.scale.y = scale;
			...
			var offset:Float = 108 - (Math.max(optionShit.length, 4) - 4) * 80;
			var menuItem:FlxSprite = new FlxSprite(480, (2 * 140)  + offset);
			menuItem.scale.x = scale;
			menuItem.scale.y = scale;
			...
			var offset:Float = 108 - (Math.max(optionShit.length, 4) - 4) * 80;
			var menuItem:FlxSprite = new FlxSprite(680, (i * 140)  + offset);
			menuItem.scale.x = scale;
			menuItem.scale.y = scale;
